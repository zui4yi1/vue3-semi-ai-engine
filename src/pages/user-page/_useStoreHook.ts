import { IEgCurd } from '@/components/eg-curd/_props';
import { IEgDrawer } from '@/components/eg-drawer/_props';
import { IEgForm } from '@/components/eg-form/_props';
...
export const useStoreHook = defineStore('useUserPageStoreHook', () => {
