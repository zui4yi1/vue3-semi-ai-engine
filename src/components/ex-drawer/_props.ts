 ...
 */
export interface IDrawerFootButton {
  name: string;
  event: string;
  type?: string;
  icon?: Component;
 ...
 * @param {Array} btns 弹窗底部footer区域的按钮, 默认为提交和取消
 * @param {Object} drawerProps 抽屉原生el-drawer的属性
 *
 */
export const props = {
  title: {
  ...
  btns: {
    type: Array as PropType<IDrawerFootButton[]>,
    default: () => [
      {
        name: '提交',
        event: 'submit',
